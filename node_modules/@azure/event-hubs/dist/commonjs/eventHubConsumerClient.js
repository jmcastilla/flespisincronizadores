...
exports.EventHubConsumerClient = void 0;
exports.isCheckpointStore = isCheckpointStore;
const eventProcessor_js_1 = require("./eventProcessor.js");
const connectionContext_js_1 = require("./connectionContext.js");
const balancedStrategy_js_1 = require("./loadBalancerStrategies/balancedStrategy.js");
const core_amqp_1 = require("@azure/core-amqp");
const greedyStrategy_js_1 = require("./loadBalancerStrategies/greedyStrategy.js");
const inMemoryCheckpointStore_js_1 = require("./inMemoryCheckpointStore.js");
const partitionGate_js_1 = require("./impl/partitionGate.js");
const unbalancedStrategy_js_1 = require("./loadBalancerStrategies/unbalancedStrategy.js");
...
class EventHubConsumerClient {
     ...
     */
    _clientOptions;
    _partitionGate = new partitionGate_js_1.PartitionGate();
    /**
     ...
     */
    static defaultConsumerGroupName = core_amqp_1.Constants.defaultConsumerGroup;
    _checkpointStore;
    ...
    constructor(_consumerGroup, connectionStringOrFullyQualifiedNamespace2, checkpointStoreOrEventHubNameOrOptions3, checkpointStoreOrCredentialOrOptions4, checkpointStoreOrOptions5, options6) {
        ...
        if ((0, typeGuards_js_1.isCredential)(checkpointStoreOrCredentialOrOptions4)) {
            // #3 or 3.1
            logger_js_1.logger.info("Creating EventHubConsumerClient with TokenCredential.");
            if (isCheckpointStore(checkpointStoreOrOptions5)) {
                ...
                this._checkpointStore = new inMemoryCheckpointStore_js_1.InMemoryCheckpointStore();
                this._userChoseCheckpointStore = false;
                this._clientOptions = checkpointStoreOrOptions5 || {};
            }
            this._context = (0, connectionContext_js_1.createConnectionContext)(connectionStringOrFullyQualifiedNamespace2, checkpointStoreOrEventHubNameOrOptions3, checkpointStoreOrCredentialOrOptions4, this._clientOptions);
        }
        else if (typeof checkpointStoreOrEventHubNameOrOptions3 === "string") {
            // #2 or 2.1
            logger_js_1.logger.info("Creating EventHubConsumerClient with connection string and event hub name.");
            ...
            this._context = (0, connectionContext_js_1.createConnectionContext)(connectionStringOrFullyQualifiedNamespace2, checkpointStoreOrEventHubNameOrOptions3, this._clientOptions);
        }
        else {
            // #1 or 1.1
            logger_js_1.logger.info("Creating EventHubConsumerClient with connection string.");
            ...
            this._context = (0, connectionContext_js_1.createConnectionContext)(connectionStringOrFullyQualifiedNamespace2, this._clientOptions);
        }
        this.identifier = this._clientOptions.identifier ?? (0, utils_js_1.getRandomName)();
    ...
    subscribe(handlersOrPartitionId1, optionsOrHandlers2, possibleOptions3) {
        ...
        if (isSubscriptionEventHandlers(handlersOrPartitionId1)) {
            ...
            if (options && options.startPosition) {
                (0, eventPosition_js_1.validateEventPositions)(options.startPosition);
            }
    ...
    _getLoadBalancingStrategy() {
        if (!this._userChoseCheckpointStore) {
            ...
            return new unbalancedStrategy_js_1.UnbalancedLoadBalancingStrategy();
        }
        ...
        if (this._loadBalancingOptions?.strategy === "greedy") {
            return new greedyStrategy_js_1.GreedyLoadBalancingStrategy(partitionOwnershipExpirationIntervalInMs);
        }
        // The default behavior when a checkpointstore is provided is
        // to grab one partition at a time.
        return new balancedStrategy_js_1.BalancedLoadBalancingStrategy(partitionOwnershipExpirationIntervalInMs);
    }
    createEventProcessorForAllPartitions(subscriptionEventHandlers, options) {
        this._partitionGate.add("all");
        if (this._userChoseCheckpointStore) {
            logger_js_1.logger.verbose("EventHubConsumerClient subscribing to all partitions, using a checkpoint store.");
        }
        else {
            logger_js_1.logger.verbose("EventHubConsumerClient subscribing to all partitions, no checkpoint store.");
        }
    ...
    createEventProcessorForSinglePartition(partitionId, eventHandlers, options) {
        ...
        if (this._userChoseCheckpointStore) {
            logger_js_1.logger.verbose(`EventHubConsumerClient subscribing to specific partition (${partitionId}), using a checkpoint store.`);
        }
        else {
            logger_js_1.logger.verbose(`EventHubConsumerClient subscribing to specific partition (${partitionId}), no checkpoint store.`);
        }
        const eventProcessor = this._createEventProcessor(this._context, eventHandlers, this._checkpointStore, {
            ...
            retryOptions: this._clientOptions.retryOptions,
            loadBalancingStrategy: new unbalancedStrategy_js_1.UnbalancedLoadBalancingStrategy(),
    ...
    _createEventProcessor(connectionContext, subscriptionEventHandlers, checkpointStore, options) {
        return new eventProcessor_js_1.EventProcessor(this._consumerGroup, connectionContext, subscriptionEventHandlers, checkpointStore, options);
    }
}
